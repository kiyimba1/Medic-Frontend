...
import EmployeeDetailsComponent from './pages/EmployeeComponent'
...
ReactDOM.render(
    <Router>
        <Switch>
            ...
            <PrivateRouteNew exact path="/viewEmployeeDetails" activepage="5" page={EmployeeDetailsComponent}></PrivateRouteNew>
